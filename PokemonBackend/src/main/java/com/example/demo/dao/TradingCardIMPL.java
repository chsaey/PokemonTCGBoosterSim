...
@Repository
public class TradingCardIMPL implements MyDAO{
    ...
    @Autowired
    public TradingCardIMPL(EntityManager entityManager) {
    ...
    public List<Object> fetchAll() {
        ...
        Query<Object> myQuery = currentSession.createQuery("from TradingCard");
    ...
    public Object fetchById(int theId) {
        Session currentSession = entityManager.unwrap(Session.class);
        return currentSession.get(TradingCard.class, theId);
    }
    ...
    public void deleteById(int theId) {
        Session currentSession = entityManager.unwrap(Session.class);
        TradingCard tradingCard = currentSession.get(TradingCard.class, theId);
        currentSession.delete(tradingCard);
    }
}
